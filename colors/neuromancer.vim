...
call Hi("Conditional", s:colors["light_purple"], "NONE", "italic")
call Hi("Function", s:colors["hot_pink"], "NONE", "NONE")
call Hi("Constant", s:colors["hot_pink"], "NONE", "NONE")
call Hi("Statement", s:colors["dark_blue"], "NONE", "italic")
call Hi("Comment", s:colors["dark_gray"], "NONE", "italic")
...
call Hi("goType", s:colors["dark_blue"], "NONE", "italic")
call Hi("goFloats", s:colors["dark_blue"], "NONE", "italic")
call Hi("goComplexes", s:colors["dark_blue"], "NONE", "italic")
call Hi("goSignedInts", s:colors["dark_blue"], "NONE", "italic")
call Hi("goUnsignedInts", s:colors["dark_blue"], "NONE", "italic")
call Hi("goUnsignedInts", s:colors["dark_blue"], "NONE", "italic")
call Hi("goDeclaration", s:colors["hot_pink"], "NONE", "italic")
call Hi("goLabel", s:colors["light_purple"], "NONE", "italic")
call Hi("goDirective", s:colors["light_purple"], "NONE", "italic")
call Hi("goDeclType", s:colors["green"], "NONE", "italic")
call Hi("goTypeDecl", s:colors["dark_blue"], "NONE", "italic")
call Hi("goBuiltins", s:colors["hot_pink"], "NONE", "italic")
